...
MongoClient.connect(db, (err, db) => {
    ...
    */
    ...
    // Use HTTPS when SSL_KEY and SSL_CERT environment variables point to cert files,
    // otherwise fall back to HTTP (development only — do not use HTTP in production).
